...
(async () => {
  ...
  if (hasReady) {
    // Second line of defense: actively zero the animation time, in case the HTML doesn't strictly
    // follow the starter tick template (e.g. lastTick uses performance.now(), which folds font-load
    // time into the first-frame dt). See references/animation-pitfalls.md §12.
